                        ...
                        {filteredTracks.length > 0 ? (filteredTracks.map((track) => {
                            switch(track.status){
                                case "failed":
                                    return(
                                        ...
                                        >
                                            <div
                                            className="bg-destructive/10 flex h-12 w-12 shrink-0 items-center justify-center rounded-md"
                                            >
                                                <XCircle
                                            ...
                                            >
                                                <h3
                                                className="text-destructive truncate text-sm font-medium"
                                                >
                                                    Generation failed
                                                </h3>
                                                <p
                                    ...
                                    return(
                                        ...
                                        >
                                            <div
                                            className="bg-muted flex h-12 w-12 shrink-0 items-center justify-center rounded-md"
                                            >
                                                <Loader2
                                                className="text-muted-foreground animate-spin h-6 w-6" 
                                                />
                                            </div>
                                            <div
                                            className="min-w-0 flex-1 "
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        {searchQuery ? "No tracks match your search" : "Create your first song to get started" }
                                    </p>
                                </h2>
                            </div>
                        )}
